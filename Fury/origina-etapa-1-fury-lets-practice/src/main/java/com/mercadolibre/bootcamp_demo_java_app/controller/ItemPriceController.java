...
public class ItemPriceController {
    ...
    public ResponseEntity<ItemUsdDTO> getItemUsdPrice(@PathVariable String itemId) throws RestException, ParseException {
        return ResponseEntity.ok(itemsService.getItemUsdDTO(itemId));
    }
}
