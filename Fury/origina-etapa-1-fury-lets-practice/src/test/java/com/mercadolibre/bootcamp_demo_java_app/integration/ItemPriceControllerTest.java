...
class ItemPriceControllerTest extends ControllerTest {
	...
	void itemPriceUSD() throws URISyntaxException, IOException {
		String itemId = "MLU467183322";
		MockItemUtils.mockItemRequest(itemId);
		MockItemUtils.mockCurrencyConversion(CurrencyEnum.UYU);
	...
	void itemPriceItemNotFound() throws URISyntaxException, IOException {
		...
		MockItemUtils.mockItemRequest(itemId, 404);
		...
		System.out.println(responseEntity.getStatusCode().toString() + responseEntity.getHeaders());
