...
CREATE TABLE `joya` (
  ...
  `posee_piedra` bit(1) NOT NULL,
  `ventaono` bit(1) NOT NULL,
...
INSERT INTO `joya` VALUES (1,'Plata','Anillo',NULL,100,_binary '',_binary '\0'),(2,'Oro','Aros',NULL,50,_binary '',_binary '\0'),(3,'Plata','Aros',NULL,50,_binary '',_binary ''),(52,'Porcelana','Vaso','Utilizada por Susana',300,_binary '\0',_binary '\0'),(53,'Porcelana','Vaso','Utilizada por Susana',300,_binary '\0',_binary ''),(102,'Porcelana','Taza','Dinastia Qing',1000,_binary '\0',_binary '');
...
INSERT INTO `joya_seq` VALUES (201);
...
-- Dump completed on 2023-10-10 10:23:39
