...
public class EmpleadoController {
    ...
    @GetMapping("/empleado/mascota/{mascota}")
    public List<Empleado> findEmpleadoByMascota(@PathVariable String mascota){
        return empleadoService.getEmpleadoByMascota(mascota);
    }
}
