...
public class PostRepositoryImpl implements PostRepository {
    ...
    @Override
    public List<Post> findPromotionPostsBySeller(User user) {
    ...
    @Override
    public Long countPromotionPostsBySeller(User user) {
        return (long) this.findPromotionPostsBySeller(user).size();
    }
}
