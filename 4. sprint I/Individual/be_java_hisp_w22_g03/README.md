...
- Obtener la cantidad de posteos en Promocion que un determinado vendedor tiene.
- Obtener los posteos en promocion que un determinado vendedor tiene.
...
- GET /products/promo-post/count?user_Id=1
- GET /products/promo-post/list?user_Id=1
