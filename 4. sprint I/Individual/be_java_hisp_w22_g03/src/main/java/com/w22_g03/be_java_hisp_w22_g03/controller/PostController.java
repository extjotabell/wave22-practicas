...
import com.w22_g03.be_java_hisp_w22_g03.dto.NumbersOfPromosDTO;
import com.w22_g03.be_java_hisp_w22_g03.dto.PostDTO;
import com.w22_g03.be_java_hisp_w22_g03.dto.ProductsInPromoDTO;
...
public class PostController {
    ...
    public ResponseEntity<ProductsInPromoDTO> getProductsInPromoBySellerId(@RequestParam long user_Id){
        return ResponseEntity.ok(postService.getPostsInPromo(user_Id));
    }
