...
public class PostController {
    ...
    public ResponseEntity<?> newPost(@RequestBody PostDto postDto){
        postService.saveNewPost(postDto, false);
    ...
    public ResponseEntity<?> getSellerPromoPostCount(@RequestParam(name = "user_id") int userId){
        return new ResponseEntity<>(postService.getPromoPostsCountFromSeller(userId), HttpStatus.OK);
    }

    @GetMapping("/promo-post/list")
    public ResponseEntity<?> getSellerPromoPostList(@RequestParam(name = "user_id") int userId){
        return new ResponseEntity<>(postService.getPromoPostsFromSeller(userId), HttpStatus.OK);
    }
}
