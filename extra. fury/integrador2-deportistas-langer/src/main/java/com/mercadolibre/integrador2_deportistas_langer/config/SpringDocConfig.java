package com.mercadolibre.integrador2_deportistas_langer.config;

import static com.mercadolibre.integrador2_deportistas_langer.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.integrador2_deportistas_langer.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("slanger")
                .email("santiago.langer@mercadolibre.com"));
