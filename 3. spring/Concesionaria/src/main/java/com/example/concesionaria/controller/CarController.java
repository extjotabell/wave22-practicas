...
public class CarController {
    ...
    @GetMapping("/prices")
    public ResponseEntity<List<AutoDTO>> getCarsByPrice(@RequestParam double since, @RequestParam double to) {
        return ResponseEntity.ok().body(carService.getCarsByPrice(since, to));
    }
}
