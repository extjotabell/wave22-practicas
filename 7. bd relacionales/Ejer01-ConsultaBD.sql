...
SELECT title, rating, release_date FROM movies WHERE YEAR(release_date) BETWEEN 2004 AND 2008;
...
SELECT title, rating, release_date FROM movies WHERE rating > 3 AND awards > 1 AND YEAR(release_date) BETWEEN 1988 AND 2009 ORDER BY rating;
