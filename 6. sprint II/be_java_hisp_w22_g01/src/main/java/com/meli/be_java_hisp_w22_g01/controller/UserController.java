...
public class UserController {
    ...
    public ResponseEntity<MessageDTO> sumAFollower(@PathVariable int userId, @PathVariable int userIdToFollow) {
    ...
    public ResponseEntity<UserFollowersListDTO> followersList(@PathVariable int userId, @RequestParam(required = false) String order) {
    ...
    public ResponseEntity<FollowedDTO> getFollowedList(@PathVariable int userId, @RequestParam(required = false) String order) {
        if (order == null) {
