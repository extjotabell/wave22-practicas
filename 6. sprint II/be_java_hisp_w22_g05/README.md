...
Se realizaron las siguients validaciones:
...
Se realizaron los siguientes test unitarios:
...
y descendente por nombre. (US-0008)
...
Se alcanzó un coverage del 77% de las lineas.

Se realizaron los siguientes tests:

##### getListOfUsersFollowedByTestOK
- endpoint : /users/{userId}/followed/list
- El json retornado debe ser correcto

##### getFollowersCountTest
- endpoint: /users/{userId}/followers/count
- La cantidad de seguidores debe ser correcta

##### getListPostsFromSellersFollowedTestOK
- endpoint: /products/followed/{userId}/list
- El json retornado debe ser correcto

##### newPostTestOK
- endpoint: /products/post
- Debe realizar el proceso y retornar un content vacío
