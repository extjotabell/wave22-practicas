...
public class PostGenerator {
    ...
    public static PostDto getPostDto(){
        ProductDto product = new ProductDto(32,"Monitor","Electronico","aaa","negro","qwe");
        return new PostDto(2, 1,LocalDate.now(),product,1,1200.0,null,null);
    }

    public static PostDto getInvalidPostDto(){
        ProductDto product = new ProductDto(1,"Monitor","Electronico","aaa","negro","qwe");
        return new PostDto(2, 1,LocalDate.now(),product,1,1200.0,null,null);
    }
}
