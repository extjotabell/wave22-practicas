...
public class PostRepository implements IPostRepository {
    ...
    public PostRepository() {
        ...
        Post post1 = new Post(1, LocalDate.now().minusDays(13), 1, carlos, product1, 200.0, false, 0.0);
        Post post2 = new Post(2, LocalDate.now().minusDays(14), 2, maria, product2, 1200.0, false, 0.0);
        Post post3 = new Post(3, LocalDate.now().minusDays(15), 3, pedro, product2, 2500.0, false, 0.0);
