...
public class UserController {
    ...
    public ResponseEntity<UserFollowedDto> follow(@PathVariable @Min(value = 1,message = "El id del seguidor debe ser mayor a 0") int userId,
    ...
    public ResponseEntity<UserFollowedDto> getListOfUsersFollowedBy(@PathVariable @Min(value = 1, message = "El userId debe ser mayor que 0") int userId, @RequestParam(required = false) String order){
        return new ResponseEntity<>(userService.getListOfUsersFollowedBy(userId, order), HttpStatus.OK);
    }

    @PostMapping("/{userId}/unfollow/{userIdToUnfollow}")
    public ResponseEntity<UserFollowedDto> unfollow(@PathVariable
    ...
    public ResponseEntity<UserFollowersDto> findUsersFollowingSeller(@PathVariable @Min(value = 1, message = "El userId debe ser mayor que 0") int userId, @RequestParam(required = false) String order){
