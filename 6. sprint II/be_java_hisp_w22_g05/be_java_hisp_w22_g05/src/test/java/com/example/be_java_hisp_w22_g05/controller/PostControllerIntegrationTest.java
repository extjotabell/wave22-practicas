...
class PostControllerIntegrationTest {
    ...
    void newPostTest() throws Exception {
        ProductDto productDto = new ProductDto(100,"celular","electro","samsung","negro","");
        PostDto postDto = new PostDto(1,1, LocalDate.of(2023,9,18), productDto, 1,200.0,false,0.0);
