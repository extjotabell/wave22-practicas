...
import com.example.be_java_hisp_w22_g05.repository.PostRepository;
...
public class PostGenerator {
    ...
    public static List<PostDto> postDtoGenerator(){
        ...
        PostDto postDto1 = new PostDto(1,4, LocalDate.now().minusDays(4),productDto,1,null,null,null);
        PostDto postDto2 = new PostDto(2,4, LocalDate.now().minusDays(2),productDto2,1,null,null,null);
    ...
    public static List<PostDto> getPostDtoListDesc(){
        ...
        expected.add(new PostDto(4,4, LocalDate.now().minusDays(3), new ProductDto(3,"Silla Gamer","Gamer","Racer", "Red and Black", "Special Edition" ), 100, 1500.0, null, null));
        expected.add(new PostDto(5,4,LocalDate.now().minusDays(4), new ProductDto(4,"Silla Gamer II","Gamer","Racer", "Blue and Black", "Special Edition" ), 101, 1700.0, null, null));
    ...
    public static List<Post> getPostList(User user){
        ...
        Post post1 = new Post(4, LocalDate.now().minusDays(3),100,user,new Product(3,"Silla Gamer","Gamer","Racer", "Red and Black", "Special Edition" ),1500.0,null,null);
        Post post2 = new Post(5, LocalDate.now().minusDays(4),101,user,new Product(4,"Silla Gamer II","Gamer","Racer", "Blue and Black", "Special Edition" ),1700.0,null,null);
