...
public class PostRepository implements IPostRepository {
    ...
    public PostRepository() {
        ...
        Post post4 = new Post(4, LocalDate.now().minusDays(3),100,javier,new Product(3,"Silla Gamer","Gamer","Racer", "Red and Black", "Special Edition" ),1500.0,null,null);
        Post post5 = new Post(5, LocalDate.now().minusDays(4),101,javier,new Product(4,"Silla Gamer II","Gamer","Racer", "Blue and Black", "Special Edition" ),1700.0,null,null);
