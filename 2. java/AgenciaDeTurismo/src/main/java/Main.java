...
public class Main {
    public static void main(String[] args) {
        ...
        //Paquete completo
        reservas.add(new Reserva(Reserva.tipoReserva.HOTEL,"", 10));
        reservas.add(new Reserva(Reserva.tipoReserva.COMIDA,"", 10));
        reservas.add(new Reserva(Reserva.tipoReserva.VIAJE,"", 10));
        reservas.add(new Reserva(Reserva.tipoReserva.TRANSPORTE,"", 10));
